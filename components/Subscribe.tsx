...
//     return (
//         <>
//       <div className='flex justify-center items-center bg-[#DFD7F9] mb-12 rounded-e-xl rounded-tl-3xl rounded-bl-xl'>
//         <div className='text-center p-4 mt-8'>
//           <span className='text-[#14183E] text-2xl font-bold'>
...
//             <div className='flex justify-center items-center px-2 bg-white rounded-md'>
