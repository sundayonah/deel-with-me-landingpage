        ...
        <>
            <div className='my-24'>
                ...
                {/* <div className='flex gap-6'>
                    {topOffers.map((deel) => (
                        <div key={deel.id} className={`flex flex-col shadow-xl rounded-lg p-4 w-full`}>
                            <div className='flex justify-start items-start'>
                            <Image src={deel.img} alt={deel.location} className='w-full h-48 object-cover' width={400} height={400} />
                            </div>
