...
//                     <Image src="/images/recentRequest.png" alt="logo-image" className='w-full h-full object-fit' width={400} height={400} />
//                 </div>
//         </div>
//     </>
//   )
        ...
        <>
            <div className='my-8'>
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 items-center'>
                    ...
                    <div>
                        <span className='text-[#5E6282]'>Recent Deel Requests</span>
                        <h1 className='font-extrabold text-2xl md:text-5xl pt-4 text-[#14183E]'>Changing The World <br /> One Deel At A Time!</h1>
                        <div className='mt-4 space-y-4'>
                            {recentDeel.map((recent) => (
                                <div key={recent.id} className='flex items-center space-x-4'>
                                    <div>
                                        <Image src={recent.img} alt='recent' className='w-12 h-16 object-contain' width={400} height={400} />
                                    </div>
                                    <div className='flex flex-col'>
                                        <span className='font-bold text-sm text-[#5E6282]'>{recent.name}</span>
                                        <span className='text-[#84829A] text-xs'>{recent.desc}</span>
                    ...
                    {/* Right Section */}
                    <div className='flex items-center justify-center -mt-32 lg:justify-end'>
                        <Image src="/images/recentRequest.png" alt="logo-image" className='w-full h-full object-cover' width={400} height={400} />
                    </div>
                </div>
            </div>
        </>
